            ...
            <div class="card" style="overflow-y: auto;border:none; border-right: 1px solid rgb(187, 187, 187);height: 80vh;">
                ...
                <div class="px-3 pb-4 d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center">
                        <img src="assets/images/profile.jpg" width="30" class="rounded-circle mr-3" alt="">
                ...
                </div><div class="px-3 pb-4 d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center">
                        <img src="assets/images/profile.jpg" width="30" class="rounded-circle mr-3" alt="">
                        <h6 style="font-size: 0.8em;">Nestor Kenneth Aniar</h6>
                    </div>
                ...
                <div class="card-body">
                    <div style="display: inline-block;" class="d-flex justify-content-center pb-5">
                        <div class="d-flex align-items-center" style=" padding: 0.5em 2em;border-radius: 1em;background-color: rgb(7, 140, 145);">
                            <img src="assets/images/profile.jpg" width="30" class="rounded-circle mr-2" alt="">
                            <h6 class="text-white">Nestor Kenneth Aniar</h6>
                        </div>
                    </div>
                    ...
                    <div class="d-flex align-items-center pb-5">
                        <div>
                            <img src="assets/images/profile.jpg" class="rounded-circle" width="50" alt="">
                            <p style="position: absolute; font-size: 0.8em;color: rgb(126, 126, 126);">Nestor kenneth Aniar</p>
                        </div>
                        <div style="position: relative;">
                            <p style="position: absolute;font-size: 0.6em; top:-15px;right:10px">10:45 pm</p>
                            <p class="mx-2 mb-0 px-3 py-2" style="color: rgb(112, 112, 112);border: 1px solid rgb(7, 140, 145);border-radius: 1em;">Hi lorem10 </p>
                        </div>
                        <div class="btn-group dropright">
                            <a data-toggle="dropdown">
                                <i style="font-size: 1em;color:rgb(166, 166, 166)" class="fas fa-ellipsis-v"></i>
                    ...
                    <div class="d-flex align-items-center justify-content-end pb-5">
                        <div style="position: relative;">
                            ...
                            <p class="mx-2 mb-0 px-3 py-2" style="color: white;background-color:  rgb(7, 140, 145);border-radius: 1em;">Hi lorem10 </p>
...
<div style="background-color: white;" class="footer">
    <div class="d-flex justify-content-between ">
        <span id="message" class="d-inline-block" style="color:rgb(7, 140, 145); font-size: 2em; "><i class="fas fa-envelope"></i></span>
